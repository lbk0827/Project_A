...
const SONIC_BOOM_VFX_SCENE := preload("res://scenes/vfx/FxSonicBoom.tscn")
...
const BASE_CAMP_STAGE_TEXTURE := preload("res://assets/stage/BaseCamp.png")
const COMBAT_STAGE_TEXTURE := preload("res://assets/stage/Stage1.png")
